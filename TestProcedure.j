...
.var 6 is z F
;
; 015 writeln('beginning of alpha')
;
	getstatic	java/lang/System/out Ljava/io/PrintStream;
	ldc	"beginning of alpha\n"
...
;
	...
	istore_3
;
; 021 q:=notpor(i=j)and(w>2)and(w/z=1.5)
;
...
;
	...
	fstore	6
;
; 024 writeln('alpha parms:  m = ',m,', n = ',n,', r = ',r:4:2,', k = ',k,', ...
;
	getstatic	java/lang/System/out Ljava/io/PrintStream;
	...
	pop
;
; 027 writeln('alpha locals: a = ',a:4:2,', b = ',b:4:2,', c = ',c:4:2,', i  ...
;
	getstatic	java/lang/System/out Ljava/io/PrintStream;
...
;
	...
	fstore_1
;
; 037 writeln('beta locals:  Hello, world! ',i+j:4:2)
;
	getstatic	java/lang/System/out Ljava/io/PrintStream;
...
;
	...
	istore_0
;
; 050 writeln('gamma parms:  i = ',i,', n = ',n,', x = ',x:4:2,', r = ',r:4: ...
;
	getstatic	java/lang/System/out Ljava/io/PrintStream;
	...
	pop
;
; 051 writeln('gamma locals: a = ',a:4:2,', b = ',b:4:2,', c = ',c:4:2)
;
	getstatic	java/lang/System/out Ljava/io/PrintStream;
...
;
; 060 writeln('main:         i = ',i,', j = ',j,', x = ',x:4:2,', y = ',y:4: ...
;
	getstatic	java/lang/System/out Ljava/io/PrintStream;
	...
	pop
;
; 062 alpha(6,i-3,x+y/i,i,j,x,y,p)
;
	bipush	6
	getstatic	TestProcedure/i I
	iconst_3
...
;
; 067 writeln('main:         i = ',i,', j = ',j,', x = ',x:4:2,', y = ',y:4: ...
;
	getstatic	java/lang/System/out Ljava/io/PrintStream;
	ldc	"main:         i = %d, j = %d, x = %4.2f, y = %4.2f, p = %b\n"
	iconst_5
...
;
; 070 writeln('main:         i = ',i,', j = ',j,', x = ',x:4:2,', y = ',y:4: ...
;
	getstatic	java/lang/System/out Ljava/io/PrintStream;
	ldc	"main:         i = %d, j = %d, x = %4.2f, y = %4.2f, p = %b\n"
	iconst_5
...
;
; 074 writeln('main:         i = ',i,', j = ',j,', x = ',x:4:2,', y = ',y:4: ...
;
	getstatic	java/lang/System/out Ljava/io/PrintStream;
	ldc	"main:         i = %d, j = %d, x = %4.2f, y = %4.2f, p = %b\n"
	iconst_5
